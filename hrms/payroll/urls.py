...
from .views import SalaryReportView, AdvancePaymentsView, AllowancesView, EmployeeSalaryPdfView, GetAllowanceData,GetAdvancePaymentData,EditAllowance,EditAdvancePayment,PayslipPdfView,PayslipInfo
